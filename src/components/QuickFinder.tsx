    ...
    <section className="bg-[#F5F8F7] py-20 md:py-24">
      <Container>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
          {quickFinder.map(({ id, title, description, icon: Icon, color }) => (
            <button
              key={id}
              className="group rounded-[22px] border border-slate-100 bg-white p-5 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-card md:p-6"
            >
              <span
